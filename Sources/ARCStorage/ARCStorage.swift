...
// - ``TestHelpers``
//
// ### CloudKit — Automatic Sync (SwiftData)
// - ``CloudKitOption``
// - ``SwiftDataConfiguration``
// - ``CloudKitSyncMonitor``
// - ``SyncState``
// - ``UnavailableReason``
//
// ### CloudKit — Manual Sync (CKSyncEngine)
...
// All properties need defaults or be optional so CloudKit can create partial objects during sync.
//
// ```swift
// @Model
// final class Restaurant: SwiftDataEntity {
//     var id: UUID = UUID()   // default value — required for CloudKit compatibility
//     var name: String = ""
//     var rating: Double = 0
//
...
//
// > Important: Do **not** use `@Attribute(.unique)` on models that sync with CloudKit.
// > CloudKit uses its own record identifiers and unique constraints cause sync failures.
// > See ``SwiftDataConfiguration`` for the full list of CloudKit model requirements.
//
// ### 2. Configure Storage
//
